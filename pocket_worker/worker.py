...
class Engine:
    ...
    def stream(self, text: str, voice_id: str, delivery: Delivery, on_audio,
        ...
        # has to be judged before that unit has measured anything. Bounded to
        # the voices this engine has spoken, and replaced rather than merged, so
        # a voice that is rebuilt quieter is not held to its old floor.
        if len(self._quiet_floor) > VOICE_CACHE:
