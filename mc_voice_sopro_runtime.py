...
``cancel`` and not a hedge: Sopro's ``stream()`` is a generator this side stops pulling from,
...
def interrupt_turn(turn) -> None:
    ...
    with what its engine can actually promise. Routing Sopro through Pocket's
